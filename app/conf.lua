...
function love.conf(t)
    t.identity = "ttsmic"                    -- The name of the save directory (string)
    ...
    t.window.title = "TTSMic"           -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 528                -- The window width (number)
    t.window.height = 136               -- The window height (number)
